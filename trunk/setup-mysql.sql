...
INSERT INTO `{db->prefix}settings` (`variable`, `value`) VALUES('show_version', 1),('version', '2.0-beta'),('password_security', 1),('reserved_names', ''),('disallowed_emails', ''),('default_event', '');

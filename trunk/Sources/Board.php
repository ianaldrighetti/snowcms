...
global $cmsurl, $db_prefix, $l, $settings, $user;
  ...
  if(count($board)>0) {  
    ...
    if((!in_array($user['group'], $board['who_view'])) && ($user['group']!=1)) {
      ...
      $result = mysql_query("
        SELECT 
          t.tid, t.sticky, t.locked, t.bid, t.first_msg, t.last_msg, t.topic_starter, t.topic_ender, t.num_replies,
          t.numviews, t.starter_id, t.ender_id, msg.mid, msg.tid, msg.uid, msg.subject, msg.post_time, msg.poster_name,
          msg2.mid, msg2.tid, msg2.uid, msg2.subject, msg2.post_time, msg2.poster_name
        ...
        WHERE 
          t.bid = $Board_ID
        ORDER BY t.sticky DESC, msg2.post_time ASC") or die(mysql_error());
        $topics = array();
        while($row = mysql_fetch_assoc($result)) {
          $topics[] = array(
            'id' => $row['tid'],

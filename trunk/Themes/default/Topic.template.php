...
<table id="topic_panel">
  <tr>
    ...
    <td style="text-align: right;">'; if(canforum('post_new')) { echo '<a href="'.$cmsurl.'forum.php?action=post&board='.$settings['bid'].'">'.$l['topic_newtopic'].'</a>'; } if(canforum('post_reply')) { echo '<a href="'.$cmsurl.'forum.php?action=post&topic='.$_REQUEST['topic'].'">'.$l['topic_reply'].'</a>'; } echo '</td>
  </tr>
</table>
';

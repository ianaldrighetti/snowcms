...
define('COREDIR', $base_dir. '/core', true);
define('THEMEDIR', $base_dir. '/themes', true);
define('PLUGINDIR', $base_dir. '/plugins', true);
define('UPLOADDIR', $base_dir. '/uploads', true);

# The address of where your SnowCMS install is accessible (No trailing /!)
define('BASEURL', '', true);
define('THEMEURL', $base_url. '/themes', true);
define('PLUGINURL', $base_url. '/plugins', true);

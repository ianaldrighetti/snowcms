...
CREATE INDEX '{db->prefix}plugins_dependencies' ON '{db->prefix}plugins' ('dependencies');
...
INSERT INTO '{db->prefix}settings' ('variable', 'value') VALUES('disallowed_email_domains', '');
...
INSERT INTO '{db->prefix}settings' ('variable', 'value') VALUES('registration_enabled', 1);
INSERT INTO '{db->prefix}settings' ('variable', 'value') VALUES('registration_type', 0);

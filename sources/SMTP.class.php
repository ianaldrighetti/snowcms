...
#
# Handles the sending of SMTP emails through the SMTP protocol.
#
# Class SMTP
#
# __construct( );
...
class SMTP
{
  ...
  # For PHP4 support :P
  #
  public function SMTP($smtp_host = null, $smtp_port = 24, $is_tls = false, $tryfor = 5)
  {
    $this->__construct($smtp_host, $smtp_port, $is_tls, $tryfor);
  }
